...
export async function SideNav({
  ...
  return (
    <aside className="sticky top-[67px] hidden h-[calc(100dvh-67px-24px)] w-56 shrink-0 flex-col overflow-y-auto border-r border-border bg-surface px-3 py-4 md:flex">
      <div>
