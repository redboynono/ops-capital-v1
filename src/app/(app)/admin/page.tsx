  ...
  return (
    <div className="mx-auto w-full max-w-[960px] px-4 py-6 md:px-6">
      ...
      <div className="grid gap-3 md:grid-cols-3">
        ...
        <Link href="/admin/growth" className="card p-4 hover:border-accent">
          <p className="label-caps">Growth Ops</p>
          <h2 className="mt-1 text-lg font-bold">网站运营中心</h2>
          <p className="mt-1 text-[13px] text-muted">DAU / UV / 增长趋势 / X 转化 / 流量归因 · 每日 5 篇英文研报分发。</p>
        </Link>
